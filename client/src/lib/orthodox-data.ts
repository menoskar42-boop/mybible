...
export const popeShenoudaQAVideos: PopeShenoudaQAVideo[] = [
  ...
  },
  {
    ...
    videoId: 'G9CjlnjX01s',
    title: 'أسئلة لاهوتية وروحية متنوعة',
    subtitle: 'درجات الملكوت والروح بعد الموت والمسامحة',
    category: 'لاهوت وعقيدة',
    icon: '🌟',
    description: 'جلسة أسئلة متنوعة يجيب فيها البابا شنودة الثالث على تساؤلات جوهرية: هل هناك درجات في السماء، وماذا تعلم الروح بعد انتقالها، وكيف تكون المسامحة الحقيقية؟',
    questions: [
      { q: 'هل هناك درجات في السماء أم الجميع متساوون في الملكوت؟', summary: 'الجميع يدخلون الملكوت ويشتركون في الفرح، لكن "نجم يمتاز عن نجم في الضياء" — كل إنسان سيأخذ مكافأته بحسب جهاده وتعبه، فمستوى القديسين يختلف عن الشخص العادي.' },
      { q: 'هل الروح تعرف ما يحدث على الأرض بعد أن تفارق الجسد؟', summary: 'نعم، الأرواح في الفردوس لديها نوع من المعرفة بما يحدث وتصلي من أجلنا — والدليل شفاعة القديسين وفرح الملائكة بخاطئ واحد يتوب.' },
      { q: 'كيف أسامح شخصاً أساء إليّ إساءة بالغة ولا أستطيع نسيانها؟', summary: 'المسامحة لا تعني نسيان الذاكرة بقرار، بل تعني عدم الانتقام وعدم الرغبة في رد الإساءة — مع الصلاة من أجل هذا الشخص تنزع المرارة تدريجياً من القلب.' },
    ],
  },
  {
    id: 'qa-bible-miracles',
    videoId: 'MO4gQ1I6DNY',
    title: 'أسئلة حول الكتاب المقدس والمعجزات',
    subtitle: 'يهوذا والشيطان وتمييز الأفكار',
    category: 'كتاب مقدس',
    icon: '📖',
    description: 'تساؤلات عميقة عن طبيعة معجزات المسيح ولماذا أمر بكتمانها، وعن دور الشيطان في سقوط يهوذا، وكيف يميّز المؤمن بين الفكر الشيطاني وفكر الذات.',
    questions: [
      { q: 'لماذا طلب المسيح أحياناً ممن صنع معهم معجزات ألا يخبروا أحداً؟', summary: 'كان ذلك لأسباب عدة: تعليم التواضع والبعد عن حب الظهور، وتجنب إثارة اليهود قبل الوقت المحدد لآلامه، أو لأن الشخص ذاته لم يحتمل الشهرة روحياً في تلك المرحلة.' },
      { q: 'هل دخل الشيطان في يهوذا بإرادته أم رغماً عنه؟', summary: 'يهوذا هو من فتح الباب بسلوكه ومحبته للمال — الشيطان لا يقتحم الإنسان رغماً عنه بل يقدم إغراءات، والإنسان بإرادته يقبل أو يرفض. يهوذا استسلم فاستغل الشيطان هذه الثغرة.' },
      { q: 'ما الفرق بين الفكر الذي من الشيطان والفكر الذي من الذات؟', summary: 'فكر الشيطان يكون مفاجئاً وغريباً عن طبيعة الشخص ويُحدث انزعاجاً — أما فكر الذات فيكون متمشياً مع رغبات الشخص وشهواته ويجد فيه نوعاً من التلذذ والقبول السريع.' },
    ],
  },
  {
    id: 'qa-youth-questions',
    videoId: 'T6YvEuFgpOg',
    title: 'مقاطع قصيرة — أسئلة الشباب',
    subtitle: 'الخدمة والصلاة وأسئلة يومية',
    category: 'حياة روحية',
    icon: '🕊️',
    description: 'سلسلة مقاطع مركزة يجيب فيها البابا شنودة الثالث على أسئلة الشباب العملية: من قضايا المرأة في الخدمة، إلى معالجة السرحان أثناء الصلاة.',
    questions: [
      { q: 'هل يجوز للفتاة ممارسة الخدمة في الكنيسة أثناء فترة الدورة الشهرية؟', summary: 'نعم، يجوز لها الحضور والخدمة والقراءة والمشاركة في كافة الأنشطة الروحية — الممنوع فقط التناول من الأسرار المقدسة بحسب قوانين الكنيسة التقليدية، لكن علاقتها بالله وصلاتها لا تتوقف.' },
      { q: 'كيف أتخلص من السرحان أثناء الصلاة؟', summary: 'الصلاة ليست مجرد تلاوة كلام بل وقوف أمام الله — حاول فهم معاني الكلمات التي تقولها، وارفع قلبك قبل لسانك. إذا سرحت عُد فور انتباهك ولا تيأس، فالله ينظر إلى المحاولة والجهاد.' },
    ],
  },
  {
    id: 'qa-divorce-soul',
    videoId: 'Mgg_SYExZ5g',
    title: 'تجميعة أسئلة — الجزء السادس',
    subtitle: 'الطلاق والنفس والروح وخلق الشيطان',
    category: 'لاهوت وعقيدة',
    icon: '🎓',
    description: 'الجزء السادس من أسئلة الناس للبابا شنودة — يتناول أحكام الطلاق في الكنيسة، والفرق الدقيق بين النفس والروح، وتساؤلاً عقائدياً عن سبب خلق الله للشيطان.',
    questions: [
      { q: 'هل يجوز للزوجين المسيحيين الانفصال بسبب سوء العشرة أو اختلاف الطباع؟', summary: 'قوانين الكنيسة واضحة: لا طلاق إلا لعلة الزنا أو تغيير الدين — سوء العشرة يُحل بالصبر والإرشاد الروحي، ويمكن الانفصال الجسدي المؤقت لتهدئة الأمور دون طلاق رسمي يُبيح زواجاً ثانياً.' },
      { q: 'ما الفرق بين النفس والروح في الإنسان؟', summary: 'الروح هي التي وهبها الله وهي خالدة وتميز الإنسان عن سائر الكائنات، أما النفس فتشمل العواطف والغرائز والمشاعر — والروح هي القائد الذي يجب أن يوجه النفس نحو الله.' },
      { q: 'لماذا خلق الله الشيطان وهو يعلم مسبقاً أنه سيسقط؟', summary: 'الله خلق ملاكاً نورانياً ومنحه حرية الإرادة — وهي أعلى كرامة للمخلوق العاقل؛ بدونها نكون كالآلات. سقوط الشيطان كان بإرادته، والله في حكمته حوّل هذا الشر ليكون وسيلة لجهاد البشر ونوالهم أكاليل الغلبة.' },
    ],
  },
  {
    id: 'qa-gospels-spirit',
    videoId: 'MO4gQ1I6DNY',
    title: 'أسئلة لاهوتية — المسيح والروح القدس',
    subtitle: 'المخطوطات وتجديف الروح القدس ووحدة الطبيعتين',
    category: 'لاهوت وعقيدة',
    icon: '✝️',
    description: 'جلسة أسئلة لاهوتية دقيقة: هل الأناجيل كُتبت مقسمة؟ وما معنى التجديف الذي لا يُغفر؟ وهل فارق لاهوت المسيح ناسوته لحظة الصلب؟',
    questions: [
      { q: 'هل كُتبت الأناجيل مقسمة إلى أصحاحات وآيات من البداية؟', summary: 'لا، القديسون كتبوا الإنجيل كنص متصل. تقسيم الأصحاحات والآيات حدث في قرون متأخرة لتسهيل البحث والاستشهاد، والمخطوطات القديمة تثبت ذلك.' },
      { q: 'ما معنى التجديف على الروح القدس الذي لا يُغفر؟', summary: 'ليس مجرد شتم أو فكر سيء، بل هو الإصرار على رفض عمل الروح القدس حتى الموت — الغفران يتطلب توبة، والتجديف هو رفض مصدر التوبة ذاته.' },
      { q: 'هل فارق لاهوت المسيح ناسوته وقت الموت على الصليب؟', summary: 'إطلاقاً — لاهوته لم يفارق ناسوته لحظة واحدة. في الموت فارقت الروح البشرية الجسد البشري، لكن لاهوته ظل متحداً بروحه وبجسده في القبر.' },
    ],
  },
  {
    id: 'qa-jealousy-vow',
    videoId: 'G9CjlnjX01s',
    title: 'أسئلة عملية في الحياة الروحية',
    subtitle: 'الغيرة والنذر والكذب الأبيض',
    category: 'حياة روحية',
    icon: '💪',
    description: 'إجابات البابا شنودة على قضايا يومية تواجه المؤمن: كيف يتعامل مع الغيرة من نجاح الآخرين، وما حكم الرجوع عن النذر، وهل يوجد شيء اسمه كذب أبيض في المسيحية؟',
    questions: [
      { q: 'كيف أتعامل مع الغيرة من نجاح الآخرين؟', summary: 'الغيرة نقص في المحبة وعدم ثقة في تدبير الله — علاجها تدريب النفس على شكر الله على ما أعطاه للغير والصلاة لأجلهم، مع تذكر أن لكل شخص وزناته ومسؤوليته الخاصة أمام الله.' },
      { q: 'هل يصح نذر شيء لله ثم الرجوع فيه أو تغييره؟', summary: 'الكتاب يقول "أن لا تنذر خير من أن تنذر ولا تفي" — النذر وعد قاطع لله. إذا كان هناك عذر قاهر يمنع الوفاء، يجب استشارة أب الاعتراف أو الأسقف لإيجاد حل، ولا يجوز إهماله ببساطة.' },
      { q: 'هل الكذب الأبيض لإنقاذ موقف مسموح به؟', summary: 'لا يوجد في المسيحية كذب أبيض وأسود — الكذب كذب. قد يلجأ الإنسان للحكمة أو الصمت في مواقف معينة، لكن لا ينبغي أن يبني نجاته على أساس من الباطل، فالصدق صفة أولاد الله.' },
    ],
  },
  {
    id: 'qa-tribulations-gossip',
    videoId: 'G9CjlnjX01s',
    title: 'أسئلة عن الضيقات والقدر والنميمة',
    subtitle: 'الأبرار والأشرار والحظ والإدانة',
    category: 'روحي وعملي',
    icon: '💡',
    description: 'يجيب البابا شنودة على أسئلة تشغل أذهان كثيرين: لماذا يعاني الأبرار بينما ينعم الأشرار؟ وهل يوجد حظ في المسيحية؟ وكيف يتحرر المؤمن من خطية النميمة؟',
    questions: [
      { q: 'لماذا يسمح الله بالضيق للأبرار بينما الأشرار في رغد من العيش؟', summary: 'الضيق للأبرار تنقية كالنار للذهب ولزيادة إكليلهم في السماء — رغد الأشرار وقتي محدود بالأرض والله يطيل أناته لعلهم يتوبون. المهم هو النهاية الأبدية لا الوضع المؤقت.' },
      { q: 'هل هناك ما يسمى بالحظ أو النصيب في المسيحية؟', summary: 'لا يوجد حظ أعمى بل تدبير إلهي — الله ضابط الكل يعلم كل شيء ويسمح بما هو للخير. ما نسميه حظاً هو إما فرصة منحها الله أو نتيجة جهد سابق أو تدبير لا نفهمه الآن.' },
      { q: 'كيف أمتنع عن النميمة وأنا أعيش في وسط يتحدث دائماً عن الآخرين؟', summary: 'إذا بدأ من حولك الكلام عن الآخرين، حاول تغيير مجرى الحديث بحكمة أو اذكر صفة جيدة في الشخص — وإذا لم تستطع فالانسحاب من الجلسة أفضل من المشاركة في الخطية.' },
    ],
  },
  {
    id: 'qa-mercy-baptism',
    videoId: 'Mgg_SYExZ5g',
    title: 'تجميعة أسئلة متنوعة — الرحمة والمعمودية والإرادة',
    subtitle: 'الترحم على غير المسيحيين والمعمودية بالغطس',
    category: 'لاهوت وعقيدة',
    icon: '✝️',
    description: 'جلسة أسئلة تتناول حدود الرحمة المسيحية نحو غير المؤمنين، وسبب إصرار الكنيسة على المعمودية بالغطس، والموقف من معضلة الإرادة الحرة.',
    questions: [
      { q: 'هل يجوز الترحم على غير المسيحيين؟', summary: 'نحن نطلب الرحمة لكل البشر فالله هو الرحوم والديان العادل — الصلاة الليتورجية مخصصة لمن هم في إيمان الكنيسة، لكن قلبنا يتسع بالحب والرحمة للجميع.' },
      { q: 'لماذا يُصر الأرثوذكس على المعمودية بالغطس؟', summary: 'لأن كلمة "معمودية" في أصلها اليوناني تعني الغمر، ولأن المعمودية هي موت مع المسيح ودفن معه — والدفن يكون بالوضع داخل القبر (الماء) ثم القيامة معه، لا بالرش.' },
      { q: 'هل الإنسان مسير أم مخير في حياته؟', summary: 'مخير في أفعاله وإرادته، ومسير في أمور خارجة عن إرادته كطوله وموعد ميلاده — الله يعرف سابقاً ما ستختاره لكن علمه السابق لا يُلزمك بالفعل؛ أنت حر في أن تقبل الخلاص أو ترفضه.' },
    ],
  },
  {
    id: 'qa-pride-enemies',
    videoId: 'MO4gQ1I6DNY',
    title: 'أسئلة روحية قصيرة — الكبرياء والغفران ومحبة الأعداء',
    subtitle: 'علامات الكبرياء الخفية وحدود محبة العدو',
    category: 'حياة روحية',
    icon: '🙏',
    description: 'إجابات مركزة وعميقة من البابا شنودة الثالث: كيف يتعرف الإنسان على كبريائه الخفي؟ وهل ينسى الله خطايانا بعد التوبة؟ وكيف تكون محبة الأعداء ممكنة عملياً؟',
    questions: [
      { q: 'ما هي علامات الكبرياء الخفية التي قد لا يشعر بها الإنسان؟', summary: 'منها: الغضب عند الانتقاد، كثرة المقاطعة في الحديث، الشعور بأن رأيك الأصح دائماً، والحديث الكثير عن النفس وإنجازاتها — التواضع الحق أن يرى الإنسان نفسه خاطئاً أمام الله مهما صنع من بر.' },
      { q: 'هل ينسى الله خطايانا بعد أن نعترف بها؟', summary: 'نعم، الكتاب يقول "لا أعود أذكر خطاياهم" — الله بمجرد التوبة والاعتراف يطرح خطايانا في أعماق البحر. الشيطان هو الذي يحاول تذكيرك بها ليُيئسك، لكن الله يمحوها بدمه الكريم.' },
      { q: 'كيف تكون محبة الأعداء ممكنة عملياً؟', summary: 'محبة الأعداء لا تعني بالضرورة العاطفة الدافئة، بل ألا تضمر لهم شراً، وألا تشمت في مصيبتهم، وأن تساعدهم إذا احتاجوا، وأن تصلي لكي يهديهم الله — هي قرار إرادي بالخير تجاههم.' },
    ],
  },
  {
    id: 'qa-priest-bones',
    videoId: 'MO4gQ1I6DNY',
    title: 'تجميعة أسئلة — الجزء الرابع',
    subtitle: 'الكهنة والزواج خارج الكنيسة ورفات القديسين',
    category: 'أسرة ومجتمع',
    icon: '👨‍👩‍👧',
    description: 'أسئلة متنوعة عملية: ما موقف البابا من الكهنة الذين يخاصمون أقاربهم؟ وما حكم من تزوج خارج الكنيسة الأرثوذكسية؟ وكيف تتعامل الكنيسة مع رفات القديسين القادم من الخارج؟',
    questions: [
      { q: 'ما رأيك في الآباء الكهنة الذين يخاصمون أقاربهم؟', summary: 'هذا عثرة كبيرة — الكاهن الذي يهدف لمصالحة الناس مع الله ومع بعضهم يجب أن يكون قدوة في علاقته الطيبة مع أهله أولاً.' },
      { q: 'شخص عمل إكليلاً في كنيسة غير أرثوذكسية — هل يمكنه تقنين وضعه الكنسي؟', summary: 'نعم، يمكن إجراء سر الزيجة الأرثوذكسي في نطاق ضيق لتقنين الوضع الكنسي، والمهم أن يُعمَّد الأبناء في الكنيسة الأرثوذكسية.' },
      { q: 'ما الموقف من رفات القديسين المستوردة من الخارج؟', summary: 'يجب الحرص الشديد — لا يجوز لأي كنيسة وضع رفات قديسين إلا بعد اعتماده رسمياً من البطريركية، لأن كثيراً من الرفات مجهولة المصدر ولا يُعرف يقيناً لمن تعود.' },
    ],
  },
  {
    id: 'qa-fig-defense',
    videoId: 'G9CjlnjX01s',
    title: 'سنوات مع أسئلة الناس — أسئلة لاهوتية',
    subtitle: 'لعنة التين والدفاع عن النفس ولقب شنودة الثالث',
    category: 'لاهوت وعقيدة',
    icon: '🎓',
    description: 'جلسة أسئلة تجمع بين التفسير الرمزي ومسائل عملية وتاريخية: ما رمزية لعنة شجرة التين؟ وهل الدفاع عن النفس يُعد قتلاً؟ ولماذا يلقّب البابا بـ"شنودة الثالث"؟',
    questions: [
      { q: 'لماذا لُعنت شجرة التين رغم أنها كانت في غير موعد ثمارها؟', summary: 'التين رمز للرياء — لأن التين يخرج قبل الورق أو معه، فوجود الورق كان يوحي كذباً بوجود الثمر. كانت رمزاً للأمة التي تملك المظهر الخارجي دون الثمر الروحي الحقيقي.' },
      { q: 'هل الدفاع عن النفس يعتبر خطية قتل؟', summary: 'الدفاع عن النفس في القوانين والشرائع لا يُعد قتل عمد — والكتاب المقدس يميز بين القتل العمدي الإجرامي وبين المواقف الاضطرارية للدفاع.' },
      { q: 'لماذا يُلقَّب قداسة البابا بـ"الثالث"؟', summary: 'لأن هناك بطريركَين سابقَين حملا اسم "شنودة": البابا شنودة الأول (البطريرك الخامس والخمسون) والبابا شنودة الثاني (البطريرك الخامس والستون) — فكان قداسته الثالث الحامل لهذا الاسم.' },
    ],
  },
  {
    id: 'qa-thoughts-vow',
    videoId: 'Mgg_SYExZ5g',
    title: 'أسئلة عملية في الخدمة والحياة',
    subtitle: 'الأفكار أثناء الصلاة والكتب غير الأرثوذكسية وشروط النذر',
    category: 'حياة روحية',
    icon: '🙏',
    description: 'إجابات تفصيلية من البابا شنودة الثالث على قضايا روحية يومية: الأفكار الشاردة أثناء التناول، ومدى جواز قراءة كتاب غير أرثوذكسي، وشروط النذر الصحيح.',
    questions: [
      { q: 'كيف نتعامل مع الأفكار التي تأتي أثناء التناول أو الصلاة؟', summary: 'لا تحزن ولا ترتبك — رفضك لهذه الأفكار دليل على أنها من الشيطان وليست منك. استمر في صلاتك ولا تعطها اهتماماً، فعدم الاهتمام بها يجعل الشيطان ييأس ويتوقف.' },
      { q: 'هل يجوز قراءة كتب لكتّاب غير أرثوذكس؟', summary: 'يجوز من أجل المعرفة والثقافة بشرط وجود أساس عقيدي متين يُمكّن من التمييز بين الفكر السليم والأخطاء العقائدية، حتى لا يتأثر القارئ بما يخالف إيمان كنيسته.' },
      { q: 'ما هي شروط النذر المقبول أمام الله؟', summary: 'النذر يجب أن يكون نابعاً من حب وشكر لا مقايضة مع الله، وأن يكون في مقدرة الإنسان الوفاء به — والأفضل دائماً استشارة أب الاعتراف قبل تقديم نذر كبير أو دائم.' },
    ],
  },
  {
    id: 'qa-bible-heresies',
    videoId: '6C4pGYI31fE',
    title: 'تجميعة أسئلة — الرد على البدع والشكوك',
    subtitle: 'مصداقية الكتاب المقدس وإنجيل برنابا',
    category: 'كتاب مقدس',
    icon: '📖',
    description: 'يرد البابا شنودة الثالث بأدلة علمية وعقائدية على شبهات مصداقية الكتاب المقدس، ويفنّد حجة أن المسيح لم يصرح بلاهوته، ويكشف حقيقة ما يُسمى بـ"إنجيل برنابا".',
    questions: [
      { q: 'هل هناك أدلة تاريخية على عدم تحريف الكتاب المقدس؟', summary: 'نعم — آلاف المخطوطات القديمة بلغات مختلفة (يونانية وقبطية وسريانية) منتشرة في متاحف العالم وكلها تتطابق في الجوهر. كما أن اقتباسات الآباء في القرون الأولى تكفي لاسترجاع الإنجيل بالكامل حتى لو فُقدت الأصول.' },
      { q: 'كيف نرد على من يقول إن المسيح لم يقل "أنا الله فاعبدوني" بلفظها الصريح؟', summary: 'الإيمان لا يُؤخذ من جملة واحدة بل من مجمل أعمال المسيح وأقواله — قبل السجود وغفر الخطايا وقال "أنا والآب واحد" و"من رآني فقد رأى الآب". الأفعال الإلهية التي نسبها لنفسه أقوى من مجرد اللفظ.' },
      { q: 'ما الرد على إنجيل برنابا الذي يدّعي بعضهم أنه الحق؟', summary: 'إنجيل برنابا مزور كُتب في العصور الوسطى (حوالي القرن السادس عشر) — يحتوي على أخطاء تاريخية وجغرافية فادحة لا يقع فيها شخص عاش في فلسطين بالقرن الأول، ويناقض نفسه في كثير من العقائد.' },
    ],
  },
  {
    id: 'qa-marriage-organs',
    videoId: 'Mgg_SYExZ5g',
    title: 'سنوات مع أسئلة الناس — الجزء السابع',
    subtitle: 'اختيار شريك الحياة والتبرع بالأعضاء والصدفة',
    category: 'أسرة ومجتمع',
    icon: '👨‍👩‍👧',
    description: 'الجزء السابع من أسئلة الناس للبابا شنودة — يتناول قضايا عائلية واجتماعية: حكم اختيار شريك الحياة بدون موافقة الأهل، والموقف من التبرع بالأعضاء، وهل توجد "صدفة" في حياة المؤمن.',
    questions: [
      { q: 'هل يجوز للشاب أو الفتاة اختيار شريك الحياة بدون موافقة الأهل؟', summary: 'من الناحية القانونية والكنسية يجوز، لكن "بركة الوالدين" مهمة روحياً واجتماعياً — يجب محاولة إقناعهم بالحوار. إذا كان رفضهم لأسباب جوهرية فيجب مراجعة النفس، وإن كان تعنتاً فيستعان بأب الاعتراف.' },
      { q: 'ما رأي الكنيسة في التبرع بالأعضاء بعد الوفاة؟', summary: 'الكنيسة لا تمانع في التبرع بالأعضاء كعمل محبة ورحمة لإنقاذ حياة إنسان، بشرط أن يكون وصية واضحة من الشخص وأن يكون عطاءً مجانياً لا تجارة أو بيعاً.' },
      { q: 'هل الصدفة لها مكان في حياة المؤمن؟', summary: 'لا توجد صدفة في قاموس المؤمن بل "سماح إلهي" — كل حدث يمر بنا إما أمر الله به لخيرنا أو سمح به لغرض روحي. شعرة واحدة من رؤوسنا لا تسقط إلا بإذن أبينا السماوي.' },
    ],
  },
  {
    id: 'qa-saints-will',
    videoId: 'MO4gQ1I6DNY',
    title: 'أسئلة روحية وعملية — تجميعة 30 دقيقة',
    subtitle: 'شفاعة القديسين ومعرفة مشيئة الله والغضب',
    category: 'روحي وعملي',
    icon: '💡',
    description: 'تجميعة مركزة من أسئلة الناس للبابا شنودة: لماذا نطلب شفاعة القديسين إن كان الله موجوداً؟ وكيف نعرف مشيئة الله في قراراتنا؟ وما حدود الغضب المسموح به للمسيحي؟',
    questions: [
      { q: 'لماذا نطلب شفاعة القديسين ولا نكتفي بالصلاة لله مباشرة؟', summary: 'نصلي لله مباشرة دائماً، لكن شفاعة القديسين صلاة توسلية — كما تطلب من صديق أن يصلي لأجلك، هكذا نطلب من القديسين الأحياء عند الرب. هي تعبير عن وحدة الكنيسة المنظورة وغير المنظورة.' },
      { q: 'كيف أعرف مشيئة الله في موضوع معين كالعمل أو الزواج أو السفر؟', summary: 'مشيئة الله تُعرف بالصلاة بحياد دون ميل قلبي مسبق، واستشارة أب الاعتراف، ودراسة الأبواب المفتوحة والمغلقة، والراحة الداخلية التي تتبع الصلاة العميقة.' },
      { q: 'هل يجوز للمسيحي أن يغضب؟', summary: 'هناك فرق بين الغضب المقدس (الغيرة على الحق بلا كراهية للشخص) والغضب الشخصي المصحوب بحقد أو رغبة انتقام — الكتاب يقول "اغضبوا ولا تخطئوا" أي لا تترك الغضب يتحول لخطية أو خصام مديد.' },
    ],
  },
  {
    id: 'qa-spirits-dreams',
    videoId: 'MO4gQ1I6DNY',
    title: 'أسئلة عن الأرواح والظواهر الروحية',
    subtitle: 'تحضير الأرواح والتناسخ والأحلام',
    category: 'لاهوت وعقيدة',
    icon: '✝️',
    description: 'يجيب البابا شنودة الثالث على أسئلة حول عالم الغيب: هل تحضير الأرواح حقيقي؟ وما موقف الكنيسة من فكرة التناسخ؟ وكيف يُميّز المؤمن بين الأحلام وأنواعها؟',
    questions: [
      { q: 'هل هناك ما يسمى بتحضير الأرواح؟ وهل هي أرواح الموتى فعلاً؟', summary: 'الكنيسة لا تؤمن بتحضير أرواح الموتى — روح الإنسان بعد موتها تذهب لمكان انتظار ولا يملك أحد استحضارها. ما يحدث في تلك الجلسات هو في الغالب عمل شياطين تتشبه بصوت المتوفى أو شكله لإضلال الناس.' },
      { q: 'هل يمكن للروح أن تنتقل من جسد إلى جسد آخر (التناسخ)؟', summary: 'هذا فكر غير مسيحي تماماً — الكتاب يقول "وُضع للناس أن يموتوا مرة واحدة ثم بعد ذلك الدينونة". لكل إنسان روح واحدة وجسد واحد سيقوم به في القيامة العامة.' },
      { q: 'ما رأي قداسة البابا في الأحلام؟ هل هي رسائل من الله؟', summary: 'الأحلام ثلاثة أنواع: أضغاث أحلام من تفكير العقل الباطن، أو حروب من الشيطان، أو رؤى من الله وهي نادرة جداً ولها شروط. النصيحة عدم الانسياق وراء الأحلام حتى لا تضطرب الحياة الروحية.' },
    ],
  },
  {
    id: 'qa-women-clergy',
    videoId: 'G9CjlnjX01s',
    title: 'أسئلة حول الخدمة والكهنوت والطقس',
    subtitle: 'المرأة والكهنوت وصلاحية الأسرار والبخور',
    category: 'لاهوت وعقيدة',
    icon: '🎓',
    description: 'أسئلة تمس النظام الكنسي الأرثوذكسي: لماذا لا تُرسَم المرأة كاهنة؟ وهل نسيان الكاهن جزءاً من الطقس يُبطل السر؟ وما الحكمة من استخدام البخور في الصلاة؟',
    questions: [
      { q: 'لماذا لا يُسمح للمرأة برتبة الكهنوت في الكنيسة الأرثوذكسية؟', summary: 'الكهنوت أبوة وتمثيل للمسيح في تقديم الأسرار — السيد المسيح اختار رسله من الرجال والرسل اختاروا خلفاءهم كذلك. هذا ليس تقليلاً من شأن المرأة (فالعذراء أعلى من الكهنة) بل تخصص وظائف منذ العصر الرسولي.' },
      { q: 'هل نسيان الكاهن لبعض الصلوات أثناء الطقس يُبطل السر؟', summary: 'لا يُبطل السر — إذا نسي الكاهن جزءاً وتذكره يمكنه تداركه، لأن فاعلية السر تعتمد على حضور الروح القدس وإيمان الكنيسة وليس على الترتيب الحرفي للكلمات.' },
      { q: 'لماذا نستخدم البخور في الصلاة؟', summary: 'البخور يرمز لصعود صلوات القديسين أمام الله ("لتستقم صلاتي كالبخور قدامك")، ويذكرنا بسحابة مجد الله التي كانت تملأ هيكل العهد القديم، ويساعد على خشوع الحواس أثناء التعبد.' },
    ],
  },
  {
    id: 'qa-confession-fasting',
    videoId: 'Mgg_SYExZ5g',
    title: 'أسئلة عن التوبة والاعتراف والصوم',
    subtitle: 'الاعتراف بالخطايا المخجلة وتغيير الأب الروحي',
    category: 'حياة روحية',
    icon: '🙏',
    description: 'جلسة أسئلة عملية دقيقة في الحياة الروحية: كيف يتجرأ الإنسان على الاعتراف بخطاياه المخجلة؟ ومتى يجوز تغيير أب الاعتراف؟ وما مفهوم الصوم الحقيقي إذا تعذّر الانقطاع عن الطعام؟',
    questions: [
      { q: 'كيف أعترف بخطايا مخجلة أمام أب الاعتراف؟', summary: 'أب الاعتراف طبيب روحي يسمع كل أنواع الخطايا ولا يستغرب منها — تذكر أنك تعترف لله في وجود الكاهن كشاهد ومصحح. خجلك الآن أمامه أفضل من الخزي أمام الكل يوم الدينونة.' },
      { q: 'هل يصح تغيير أب الاعتراف إذا شعرت بعدم الاستفادة؟', summary: 'الأصل الاستقرار مع أب واحد لكي يعرف تاريخك الروحي — لكن إذا كان هناك سبب قهري فيجب الاستئذان والتحدث بصراحة قبل الانتقال، لكي يكون لغرض روحي لا هروباً من الحزم.' },
      { q: 'هل الصوم بدون انقطاع عن الأكل يعتبر صوماً مقبولاً؟', summary: 'جوهر الصوم الانقطاع لفترة لكي يسود الروح على الجسد — إذا منع عذر صحي الانقطاع فالكنيسة تسمح بالأكل النباتي مباشرة، لكن يجب أن يصاحبه صوم عن الشهوات والكلام الزائد، إذ الصوم الروحي أهم من الجسدي.' },
    ],
  },
];
