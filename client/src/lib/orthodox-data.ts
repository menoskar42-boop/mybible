...
export const popeShenoudaQAVideos: PopeShenoudaQAVideo[] = [
  {
    id: 'qa-people-wisdom',
    videoId: 'Rd8_CViQhDs',
    title: 'أسئلة الشعب إلى البابا شنودة',
    subtitle: 'إجابات مليئة بالحكمة',
    category: 'روحي وعملي',
    icon: '💡',
    description: 'مجموعة من أسئلة الشعب القبطي إلى قداسة البابا شنودة الثالث — الذي اشتهر بحكمته في الإجابة على القضايا الروحية والاجتماعية بأسلوب بسيط وعميق.',
    questions: [
      { q: 'كيف أتعامل مع الإنسان الذي يؤذيني دائماً وأنا أحبه؟', summary: 'الحب الحقيقي لا يشترط التغاضي عن الخطأ — بل تواجه الإنسان بمحبة وتحتمل ضعفه في نفس الوقت.' },
      { q: 'هل تنتهي المشاعر الدينية مع مرور الزمن؟', summary: 'المشاعر وحدها ليست معيار الإيمان — الإيمان الحقيقي يقوم على الإرادة والقرار لا على العاطفة المتقلبة.' },
      { q: 'ما الفرق بين التوبة الحقيقية والندم العابر؟', summary: 'الندم يكسر القلب لكنه قد لا يغير الحياة. التوبة الحقيقية هي قرار داخلي يصاحبه تغيير فعلي في السلوك.' },
      { q: 'كيف أواجه أفكار الشك التي تراودني؟', summary: 'الشك ليس خطيئة بل طريق للبحث عن اليقين — يجب أن يقابَل بالدراسة والصلاة والحوار مع الأب الروحي.' },
    ],
  },
  {
    id: 'qa-masheeaa',
    videoId: 'xHsnEJPLpLc',
    title: 'لتكن مشيئتك يا رب — أنا بين إيديك',
    subtitle: 'أسئلة روحية عميقة',
    category: 'إيمان وتسليم',
    icon: '🕊️',
    description: 'جلسة أسئلة حول التسليم لمشيئة الله والثقة به في وقت الضيق — من أجمل جلسات البابا شنودة الروحية.',
    questions: [
      { q: 'كيف أقبل مشيئة الله حين تكون مؤلمة؟', summary: 'مشيئة الله دائماً لخيرنا حتى لو لم نفهمها في الحال — والتسليم لها هو أرقى درجات الإيمان.' },
      { q: 'ما معنى "أنا بين إيديك يا رب" عملياً في حياتنا؟', summary: 'أن تضع كل قراراتك ومخاوفك في يد الله بلا قلق — ثقة كاملة أنه يدير حياتك بحكمة ومحبة لا نفهمها دائماً.' },
      { q: 'كيف أثق بالله حين لا أرى مخرجاً؟', summary: 'الثقة بالله لا تقوم على رؤية الحل، بل على معرفة طبيعة الله المحب القادر — من عرف الله أحبه ومن أحبه أمنه.' },
      { q: 'هل القبول بالواقع يعني التقاعس عن تغيير الأوضاع؟', summary: 'القبول الروحي لا يعني السلبية — اعمل بكل ما في وسعك ثم سلّم النتيجة لله بثقة ودون قلق.' },
    ],
  },
  {
    id: 'qa-spiritual-fasting',
    videoId: 'r2VoW9aQJ1s',
    title: 'أسئلة روحية — صيام وقديسون وصلاة',
    subtitle: 'مجموعة متنوعة',
    category: 'صيام وصلاة',
    icon: '🙏',
    description: 'مجموعة أسئلة تشمل الحياة الروحية العملية: الصيام والصلاة وشفاعة القديسين — من أجمل جلسات الأسئلة المتنوعة.',
    questions: [
      { q: 'هل الصيام الجزئي مقبول إذا كان الإنسان مريضاً؟', summary: 'الصيام الجزئي مقبول للمريض، والله ينظر للنية والقلب لا للشكل الخارجي فقط — "رحمة أريد لا ذبيحة".' },
      { q: 'كيف نطلب شفاعة القديسين وما هي حدودها؟', summary: 'القديسون أحياء في المسيح ويشفعون لنا — نطلب شفاعتهم لا عبادتهم، كما نطلب من صديق أن يصلي معنا.' },
      { q: 'هل يمكن الصلاة بأي لغة أو لا بد باللغة القبطية؟', summary: 'الصلاة بأي لغة مقبولة لأن الله يسمع القلب لا اللسان — اللغة القبطية لها قدسية تراثية لكنها ليست شرطاً.' },
      { q: 'ما هي شروط الصلاة التي يسمعها الله؟', summary: 'قلب منكسر وإيمان وخلو من الحقد — "إن كنتم واقفين تصلون فاغفروا" هو المفتاح الذي قاله المسيح.' },
    ],
  },
  {
    id: 'qa-seminary-theology',
    videoId: 'tQPI6gkO84g',
    title: 'أسئلة متنوعة — محاضرات الإكليريكية',
    subtitle: '15 مارس 1988',
    category: 'لاهوت وعقيدة',
    icon: '🎓',
    description: 'من سلسلة محاضرات البابا شنودة في الكلية الإكليريكية — جلسة أسئلة متنوعة في العقيدة واللاهوت للكهنة والطلاب.',
    questions: [
      { q: 'ما الفرق بين الخطيئة الجسيمة والخطيئة البسيطة في الإيمان الأرثوذكسي؟', summary: 'الكنيسة لا تفرّق تفريقاً مطلقاً كالكاثوليكية — كل خطيئة تحتاج توبة، لكن هناك خطايا تُفقد النعمة وأخرى أدنى منها.' },
      { q: 'هل يجوز للمسيحي قراءة كتب من ديانات أخرى؟', summary: 'الراسخ في إيمانه يستطيع القراءة لفهم الآخرين — أما من يتزعزع فالأولى تقوية إيمانه أولاً قبل الاطلاع على غيره.' },
      { q: 'ما معنى الكفارة في المفهوم القبطي الأرثوذكسي؟', summary: 'الكفارة هي إعادة الاتحاد بين الله والإنسان بتجسد وصلب وقيامة المسيح — ليست فقط "سداد دين" كما في المفهوم الغربي.' },
      { q: 'كيف نفهم الإرادة الحرة مع علم الله المسبق؟', summary: 'الله يعلم مسبقاً لكنه لا يُجبر — كمن يعلم أن صديقه سيفعل شيئاً دون أن يُرغمه. العلم المسبق لا يلغي الحرية.' },
    ],
  },
  {
    id: 'qa-seminary-family',
    videoId: 'Q8-Fr2jqGVQ',
    title: 'أسئلة عن الأسرة والمجتمع',
    subtitle: '27 ديسمبر 1988 — الإكليريكية',
    category: 'أسرة ومجتمع',
    icon: '👨‍👩‍👧',
    description: 'جلسة أسئلة من الكلية الإكليريكية تتناول قضايا الأسرة والخلافات وعودة التائبين — إجابات عملية وواضحة.',
    questions: [
      { q: 'إنسان اضطر لمغادرة المسيحية بسبب خلافات عائلية — هل يمكنه العودة؟', summary: 'باب التوبة مفتوح دائماً — الكنيسة تقبل العائد بمحبة، ويخضع لفترة اعتراف وإعداد روحي ثم يُستقبل في الجماعة.' },
      { q: 'كيف أتعامل مع أقاربي الذين يرفضون الإيمان؟', summary: 'الشهادة بالحياة أقوى من الكلام — عش إيمانك بجوارهم بصدق وسلام ودعة، ودع النعمة تعمل في قلوبهم.' },
      { q: 'هل الخلافات الزوجية تؤثر على الحياة الروحية؟', summary: 'الخلافات الأسرية تضعف الحياة الروحية إذا لم تُحَل — لذا الكنيسة تركز على قدسية الزواج والتسامح المتبادل.' },
      { q: 'كيف نُربّي أولادنا على الإيمان في عصر الانفتاح؟', summary: 'التربية بالقدوة لا بالكلام فقط — الطفل يرى آباءه يصلون ويصومون ويحبون الآخرين، فيحمل هذا في داخله.' },
    ],
  },
  {
    id: 'qa-people-part1',
    videoId: 'zAU9UyeIC6k',
    title: 'البابا يجاوب أسئلة الشعب — رسائل إيمانية',
    subtitle: 'مجموعة مختارة',
    category: 'روحي وعملي',
    icon: '🌟',
    description: 'مجموعة رائعة من أسئلة الشعب للبابا شنودة الثالث — بأسلوب بسيط وواضح يقدم رسائل إيمانية عميقة ومؤثرة.',
    questions: [
      { q: 'كيف أحب عدوي عملياً وليس مجرد كلام؟', summary: 'محبة العدو تبدأ بعدم رغبة الانتقام، ثم الصلاة من أجله، ثم حمل يده إن أمكن — هذه مراحل الوصول للمحبة الكاملة.' },
      { q: 'هل يجوز الغضب للمسيحي؟', summary: 'الغضب مشاعر طبيعية، لكن المهم كيف تديره — غضب يدافع عن حق بلا حقد جائز، أما الغضب الممتد فيدمر صاحبه أولاً.' },
      { q: 'لماذا يسمح الله بآلام الأبرار؟', summary: 'الآلام تصقل الإنسان وتعمق علاقته بالله — أيوب نموذج، والمسيح نفسه "تعلّم الطاعة مما تألّم" كما يقول الكتاب.' },
      { q: 'كيف أعرف إن كنت أفكر في كلمة الله أم في مصلحتي؟', summary: 'كلمة الله تبني وتعطي وتنسيك نفسك — أما التفكير في الذات فيقودك نحو الداخل بانعزال عن الآخرين والله.' },
    ],
  },
  {
    id: 'qa-bible-veracity',
    videoId: 'ftu1TO_tkVs',
    title: 'أسئلة عن صحة الكتاب المقدس',
    subtitle: '2 مارس 1993 — الإكليريكية',
    category: 'كتاب مقدس',
    icon: '📖',
    description: 'محاضرة متخصصة في الكلية الإكليريكية للرد على أسئلة عن مصداقية الكتاب المقدس وطريقة تفسيره الصحيحة.',
    questions: [
      { q: 'كيف نرد على من يقول إن الكتاب المقدس محرّف؟', summary: 'المخطوطات القديمة المتعددة والمتوافقة دليل على السلامة — آلاف النسخ من ثقافات مختلفة متطابقة في جوهرها.' },
      { q: 'هل كل ما في الكتاب المقدس حرفي أم بعضه رمزي؟', summary: 'الكتاب يحتوي أنواعاً أدبية مختلفة: تاريخ وشعر ونبوة ورمز — وفهم كل نوع بطريقته هو التفسير السليم.' },
      { q: 'كيف نفهم الآيات التي تبدو متناقضة؟', summary: 'ما يبدو تناقضاً في الغالب اختلاف في الظروف أو السياق أو الهدف — يُحَل بدراسة النص في سياقه الكامل.' },
      { q: 'ما الدليل على أن الكتاب المقدس موحى به من الله؟', summary: 'النبوات التي تحققت، والتحول الجذري في حياة قارئيه، وتأثيره الفريد عبر آلاف السنين — كل هذا شهادة على وحيه.' },
    ],
  },
  {
    id: 'qa-laugh-wisdom',
    videoId: 'd5Jxe2m4tcA',
    title: 'لا تخف — الشر لن ينتصر',
    subtitle: 'عظة وأسئلة',
    category: 'روحي وعملي',
    icon: '💪',
    description: 'يتحدث البابا شنودة الثالث عن موضوع "متخافش الشر عمره ما ينتصر" — مع أسئلة عملية عن كيفية مواجهة الصعاب.',
    questions: [
      { q: 'كيف لا أخاف حين يحيط بي الشر من كل جانب؟', summary: 'الشر يبدو قوياً لكنه ضعيف أمام الله — التاريخ يثبت أن كل الأنظمة الظالمة زالت، والكنيسة بقيت.' },
      { q: 'هل الشر ينتصر أحياناً؟', summary: 'الشر قد يكسب جولة، لكن المعركة الأخيرة للحق دائماً — "وأبواب الجحيم لن تقوى عليها" قالها الرب عن كنيسته.' },
      { q: 'كيف أتعامل مع الظلم الواقع عليّ؟', summary: 'الظلم اختبار للصبر والإيمان — اعمل بحقك بالطرق المشروعة، وإن لم تجد ردّاً فالله يأخذ لك حقك.' },
    ],
  },
];

export const popeShenoudaQACategories = ['الكل', 'روحي وعملي', 'إيمان وتسليم', 'صيام وصلاة', 'لاهوت وعقيدة', 'أسرة ومجتمع', 'كتاب مقدس'];
