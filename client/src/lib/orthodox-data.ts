...
export const popeShenoudaQAVideos: PopeShenoudaQAVideo[] = [
  // ── فيديو 1 ── MO4gQ1I6DNY ─────────────────────────────────────
  {
    ...
    questions: [
      { q: 'أنا شاب بحاول ابدأ في حياة التوبة، وعندما ابدأ تهجم علي الأفكار الخاطئة — فما الحل؟', summary: 'طبيعي إن الشيطان لما يلاقيك عايز تتوب يعكسك، فمفروض تجاهد، وكل ما ربنا يلاقيك بتجاهد وبتثبت نعمة ربنا تشتغل معاك وتساعدك، ما تخافش ده شيء طبيعي.' },
      { q: 'والدي ووالدتي وقت ما اتجوزوا عملوا إكليل في كنيسة خمسينية وهم الآن معاهم ست أولاد، فهل يعتبر زواجهم باطل؟ وهل يعملوا إكليل أرثوذكسي من جديد؟', summary: 'مفروض إن علشان حياتهم تكون ماشية صح ياخدوا سر الزيجة من الكنيسة، ولو في أوضة مغلقة من غير ما حد يحس بيهم ممكن، يعني لازم. أما المهم بالنسبة للأولاد: هل عمدوهم عند الخمسينيين ولا عمدوهم أرثوذكس؟ ده اللي يهمنا.' },
      { q: 'بعد عودتي للكنيسة بعد فترة انقطاع طويلة دايماً يجيني شكوك — ما الحل؟', summary: 'الشيطان برضه بيحسدك على رجوعك للكنيسة وبيحاربك، خليك شديد كده وثابت.' },
      { q: 'ما تفسير قول الكتاب: "لا تدعوا لكم أباً على الأرض"؟', summary: 'موجودة في كتاب الكهنوت إجابة طويلة عريضة على هذا الموضوع تقدر تقراها.' },
      { q: 'نسي الأب الكاهن أن يجحد الشيطان قبل تعميد الطفل فجحده بعد العماد — فهل العماد صحيح؟', summary: 'ما يهمش، إحنا نجحد الشيطان في أي وقت. هو مفروض يجحد الشيطان قبل العماد، لكن إذا كان نسي الكاهن فممكن جحد الشيطان في أي وقت. معلش تتصلح.' },
      { q: 'ما رأيكم في خصام بعض الآباء الكهنة لأقاربهم؟', summary: 'طبعاً عثرة وحشة، ومفروض الكاهن اللي بيصلح الآخرين ويصالحهم يكون في علاقة طيبة مع أهله وقرايبه.' },
      { q: 'أين يوجد إيليا وأخنوخ الآن؟ وهل السيد المسيح موجود في الفردوس أم في سماء السماوات؟', summary: 'هم طبعاً موجودين في السماء في مكان ما. السيد المسيح موجود في الفردوس وفي سماء السماوات وفي كل مكان.' },
      { q: 'أنا من سوهاج وأعمل مفتش تحقيقات وأرغب في العمل بالمحاماة — فهل هي مهنة حرام؟', summary: 'مسموح طبعاً، حد يقدر يقول حرام؟ بس كمحامي حامي عن المظلومين ودافع عن حقوق الناس. تتوقف على طبيعة الإنسان من جوه — كل شغلة في الدنيا ممكن الواحد يسلك فيها بأمانة وممكن يسلك بغير أمانة.' },
      { q: 'توجد في إحدى الكنائس أجساد مستوردة للأنبا أنطونيوس والأنبا باخوميوس — هل قداستكم سمحتم بذلك؟', summary: 'الموضوع يحتاج إلى بحث شديد جداً. مش أصول كنيسة تحط أي حاجة من الرفات اللي بيعطى من الخارج غير لما يُعتمد هذا الأمر من البطريركية — الحرص الشديد مطلوب لأن كتير منها مجهولة المصدر.' },
      { q: 'هل الله خلق الإنسان ليحل محل الملائكة الساقطين؟', summary: 'طبعاً لا. خليقة الإنسان خليقة منفردة بطبعها لها نوعية خاصة. ربنا أراد إن يخلق نوعاً جديداً من المخلوقات الحية العاقلة المتصلة بالمادة والجسد — مش بديل. إذا أطاعت الله وانتصرت على المادة تكون وكأنها أقوى من الملائكة الذين لم يحاربوا بالجسم.' },
      { q: 'في صيام الميه والملح — هل يصح مع وجود زيت داخل الخضروات طبيعياً؟', summary: 'الصيام والنذر حسب ضمير الإنسان وليس حسب معمل التحليل. اللي بينذر ميه وملح بينذر إنه ما بيستعملش حاجات فيها زيت صرف — ما بيحطش زيت على فول أو طبيخ أو مقليات. الآباء اللي بيعقدوا الكلام ده على الناس بيريحوا نفسهم ومش بيريحوا الناس.' },
      { q: 'إذا كان هيرودس يريد قتل الصبي، لماذا لم يرسل مع المجوس جنوداً من عنده؟', summary: 'لو بعت جنود هتنكشف الحكاية. هو حب إن المجوس ناس عاديين ماشيين هيخشوا أي بيت ماحدش ياخد باله منهم، فلما يعرفوا يقولوا له بعدين يبعت الجنود. مش وصل لذكاء صاحب السؤال.' },
      { q: 'هل كتب القديسون الأربعة الإنجيليون البشائر مقسمة إلى أصحاحات وآيات؟', summary: 'لا طبعاً، كاتبين الإنجيل كله ورا بعضه مفيش لا تقسيم لا أصحاحات. دي جت فيما بعد في قرون متأخرة. المخطوطات القديمة للأناجيل مفيهاش هذه التقاسيم أبداً.' },
      { q: 'قال الرب في الوصايا "لا تقتل" — ولكن إذا قتل الإنسان دفاعاً عن نفسه فما مصيره؟', summary: 'الدفاع عن النفس ما بيعتبرش خطية، وفي آيات في الكتاب المقدس عن كدا.' },
      { q: 'لماذا سمي قداستكم باسم الثالث والبابا كيرلس باسم السادس؟', summary: 'سميت بالثالث لأن في اتنين بابوات قبل كدا باسم شنودة: الأول كان البابا 55 والثاني كان البابا 65، فاللي يجي بعدهم بهذا الاسم يبقى ثالث. البابا كيرلس لأن البابا كيرلس الخامس تنيح سنة 1926 فيبقى اللي جاء بعده السادس.' },
      { q: 'نحن نؤمن أن لاهوت المسيح لم يفارق ناسوته بعد موته — ما التعليم الكتابي الصحيح في هذا؟', summary: 'مش بس بعد الموت — لاهوته لم يفارق ناسوته من أول ما اتحد اللاهوت بالناسوت في بطن مريم، وعلى طول باستمرار، هو ده التعليم الكتابي الصحيح.' },
      { q: 'لماذا كان المسيح كلما صنع معجزة يطلب من صاحبها ألا يخبر أحداً؟', summary: 'مش في كل مرة كان يقول كدا. في بعض الأوقات كان يقوله لا تخبر أحداً، وفي أوقات أخرى كان يقوله اذهب وحدث بكم صنع الرب بك. الظرف والغرض بيختلف من مناسبة لأخرى.' },
      { q: 'جاء في الإنجيل أن يهوذا دخله الشيطان بعد أخذ اللقمة — فهل كان خيانته بإرادته الحرة أم بفعل الشيطان؟', summary: 'إرادته استسلمت لعمل الشيطان — يبقى الاتنين داخلين في بعض. وهو من يوم الأربعاء قبلها راح اتفق على التسليم، فربما دخول الشيطان جاء يُسرع في العملية. الشيطان بيدفع إلى الإسراع في العمل.' },
      { q: 'هل كل عمل شرير يصدر من الإنسان نتيجة وجود الشيطان فيه؟ وكيف نفرق بين الفكر الشرير من القلب والفكر من الشيطان؟', summary: 'في عمل شرير يأتي بالإرادة الحرة، وفي عمل شرير يأتي بإغراء من الشيطان أولاً. الشيطان ليست له قوة إرغام وإنما له عمل اقتراح لا يزيد عن كدا. إذا كانت الفكرة من الشيطان فقط تجد القلب يرفضها من الداخل ويقاومها. أما الفكرة الآتية من القلب فليست فيها مقاومة داخلية بل فيها رضا واتفاق وتنفيذ.' },
      { q: 'هل يُسمح للمرأة الحائض بالتناول أو دخول الكنيسة؟', summary: 'بالنسبة لدخول الكنيسة والصلاة وحضور القداس فده مسموح به تماماً مفيش أي مانع. أما بالنسبة للتناول من الأسرار المقدسة، فالعرف الكنسي والتقاليد المستقرة بتفضل إنها تؤجل التناول لفترة الطمث كنوع من الاستعداد الجسدي والنفسي الخاص، إلا في حالات الضرورة القصوى أو المرض الشديد.' },
      { q: 'ما هو الرد على من يقول أن الصليب كان لعنة فكيف نكرمه؟', summary: 'الصليب كان لعنة في العهد القديم لأن "ملعون كل من علق على خشبة"، لكن المسيح بصلبه عليه "حمل لعنتنا" وحول الصليب من آلة تعذيب ولعنة لعلامة فخر وخلاص. الصليب دلوقتي هو القوة اللي هزمنا بيها الشيطان، وعشان كدا بنكرمه وبنرسمه وبنفتخر بيه.' },
      { q: 'هل مشاهدة التلفزيون أو السينما تعتبر خطية؟', summary: 'السينما والتلفزيون وسيلة، والوسيلة في حد ذاتها مش خطية. الخطية في "المحتوى". لو المحتوى بيبني الإنسان أو بيعطيه معلومة أو ترفيه بريء فده مفيش فيه مانع. لكن لو المحتوى بيثير الشهوات أو بيعلم العنف أو بيضيع الوقت في كلام تافه، فـ هنا تبقى الخطية. المسيحي لازم يكون عنده "إفراز" وحكمة في اختيار اللي بيشوفه.' },
      { q: 'هل يجوز للمسيحي أن يقترض من البنك بفوائد؟ وهل دي تعتبر ربا؟', summary: 'البنوك دلوقتي مؤسسات استثمارية وتجارية، والتعامل معاها مش زي "الربا" اللي كان بيستغل حاجة الفقير. الفايدة في البنك هي نصيب من ربح المشروع اللي البنك بيعمله. فلو إنسان بيقترض علشان يعمل مشروع أو يشتري حاجة ضرورية، ده تعامل تجاري مسموح به، المهم إنه ما يتحولش لطمع أو يغرق نفسه في ديون مش قادر يسددها.' },
    ],
  },
  // ── فيديو 2 ── Mgg_SYExZ5g ─────────────────────────────────────
  {
    ...
    subtitle: 'تفريغ حرفي — غيبيات وصلاة عن الأموات ورهبنة وزواج',
    category: 'روحي وعملي',
    icon: '🕊️',
    description: 'الجزء الخامس من سلسلة أسئلة الناس للبابا شنودة الثالث — تفريغ حرفي لما نطق به قداسته بأسلوبه المصري البسيط.',
    questions: [
      { q: 'ما رأي قداسة البابا في الغيبيات، أو معرفة المستقبل عن طريق قراءة الكف أو الفنجان؟', summary: 'الإجابة حازمة بأن هذه الأمور ضد الإيمان المسيحي وتدخل في نطاق السحر والشعوذة. الإنسان يجب أن يضع مستقبله في يد الله وحده ولا يسعى لمعرفة الغيب بطرق ملتوية؛ لأن ده بيفتح باب للشيطان إنه يسيطر على فكر الإنسان ويقوده للوهم.' },
      { q: 'هل يجوز الصلاة من أجل المنتقلين؟ يعني نصلي للي ماتوا؟', summary: 'نعم، الكنيسة تصلي من أجل الراقدين لطلب الرحمة لهم، ولأنهم لا يزالون أعضاء في جسد المسيح الواحد. بنقول في الأوشية "لأنه ليس موت لعبيدك بل هو انتقال"، فهم أحياء بالروح ومحتاجين لصلواتنا كنوع من الشركة والمحبة.' },
      { q: 'لماذا لا تتزوج الراهبات أو الرهبان؟ وهل الجواز في حد ذاته غلط؟', summary: 'الجواز مش غلط طبعاً، الجواز سر مقدس وربنا باركه في عرس قانا الجليل. لكن الرهبنة هي حياة اختيارية للتفرغ الكامل للعبادة وحب الله. هي "نذر" يقدمه الإنسان بكامل إرادته ليعيش حياة البتولية والزهد، زي ما قال الكتاب "يوجد خصيان خصوا أنفسهم لأجل ملكوت السماوات"، وده اختيار لمن يقدر أن يقبل.' },
      { q: 'هل يجوز للزوجين المسيحيين الانفصال بسبب سوء العشرة أو اختلاف الطباع؟', summary: 'قوانين الكنيسة واضحة؛ "لا طلاق إلا لعلة الزنا" أو تغيير الدين. سوء العشرة يُحل بالصبر والإرشاد الروحي ومحاولة التغيير من الذات. وممكن اللجوء للانفصال الجسدي مؤقتاً لتهدئة الأمور لكن دون طلاق رسمي يسمح بزواج ثانٍ، لأن ما جمعه الله لا يفرقه إنسان.' },
      { q: 'ما هو الفرق بين النفس والروح؟ هل هم حاجة واحدة؟', summary: 'الروح هي التي وهبها الله للإنسان وهي خالدة وتميزه عن باقي الكائنات، أما النفس فهي تشمل العواطف والغرائز والمشاعر التي يشترك فيها الإنسان أحياناً مع الكائنات الحية الأخرى. الروح هي القائد الذي يجب أن يوجه النفس نحو الله، والجسد هو الوعاء الذي يحوي الاثنين.' },
      { q: 'هل يجوز للشاب أو الفتاة اختيار شريك الحياة بدون موافقة الأهل؟', summary: 'من الناحية القانونية والكنسية يجوز، ولكن من الناحية الروحية والاجتماعية "بركة الوالدين" مهمة جداً. يجب محاولة إقناعهم بالحوار، وإذا كان رفض الأهل مبنياً على أسباب جوهرية زي الأخلاق أو الإيمان فيجب مراجعة النفس، أما إذا كان الرفض لمجرد التعنت فيجب استشارة أب الاعتراف للتدخل.' },
      { q: 'ما هو الفرق بين التجديف على الروح القدس والخطايا العادية؟ وهل له مغفرة؟', summary: 'التجديف على الروح القدس مش هو مجرد فكر وحش أو كلمة صعبة، لكن هو "الإصرار على رفض عمل الروح القدس" لحد الموت. يعني إنسان رافض يتوب، ورافض نداء ربنا في قلبه تماماً. طالما هو رافض المصدر اللي بيجيبه للتوبة فإزاي هيتغفر له؟ الغفران محتاج توبة، والرفض المستمر للتوبة هو ده اللي ملوش مغفرة.' },
      { q: 'لماذا نطلب شفاعة القديسين ولا نكتفي بالصلاة لله مباشرة؟', summary: 'إحنا بنصلي لربنا مباشرة طبعاً، لكن شفاعة القديسين دي صلاة توسلية. زي ما بتطلب من صديق ليك على الأرض إنه يصلي لك، إحنا بنطلب من القديسين اللي هما أحياء عند الرب إنهم يسندونا بصلواتهم. دي شركة حب ووحدة بين الكنيسة اللي على الأرض والكنيسة اللي في السماء.' },
      { q: 'هل يجوز الترحم على غير المسيحيين؟', summary: 'إحنا بنطلب الرحمة لكل البشر، ربنا هو "الرحوم" والديان العادل اللي بيفحص القلوب. في صلواتنا العامة بنطلب من أجل سلام العالم كله والخليقة كلها. أما الصلاة في القداس فهي مخصصة للي في إيمان الكنيسة، لكن قلوبنا لازم تتسع بالحب والرحمة لكل الناس.' },
      { q: 'هل يوجد اعتراف أمام صور القديسين أو بيني وبين ربنا مباشرة بدون كاهن؟', summary: 'الاعتراف بينك وبين ربنا ده بنسميه "محاسبة نفس" أو توبة، وده لازم يكون كل يوم. لكن "سر الاعتراف" لازم يكون قدام الكاهن، لأن المسيح قال للرسل: "من غفرتم خطاياهم تغفر لهم ومن أمسكتموها أمسكت". الكاهن بياخد منك الاعتراف وبيديك الإرشاد الروحي وبيقرا لك "التحليل" اللي هو تصريح بالغفران بسلطان من ربنا. الاعتراف قدام الصور مجرد فضفضة لكنه مش سر كنسي.' },
      { q: 'الأطفال الذين يموتون قبل العماد، ما هو مصيرهم؟', summary: 'إحنا بنتركهم لرحمة ربنا الواسعة، هما طبعاً لم يرتكبوا خطايا فعلية. إحنا ما نقدرش نحدد مصيرهم لأن ربنا هو الديان، لكننا نؤمن إن ربنا عادل ورحيم جداً. وفي نفس الوقت بنشدد على سرعة تعميد الأطفال علشان نضمن لهم الشركة في جسد المسيح.' },
    ],
  },
  // ── فيديو 3 ── T6YvEuFgpOg ─────────────────────────────────────
  {
    ...
    questions: [
      { q: 'كيف أختار أب اعترافي؟ وما هي المعايير التي أعتمد عليها؟', summary: 'أب الاعتراف ده طبيب روحي، لازم تختار الشخص اللي ترتاح له نفسياً، وتحس إنك تقدر تفتح له قلبك من غير خوف أو خجل. مش مجرد واحد بتقوله خطاياك وخلاص، لا، لازم يكون إنسان حكيم يقدر يرشدك في طريق ربنا، ويكون عنده وقت يسمعك ويوجهك. ولو لقيت أب اعتراف مريح وثابت معاك، خليك معاه علشان يعرف تاريخك الروحي ويقدر يتابع نموك خطوة بخطوة.' },
