...
export const pageSEOConfig: Record<string, PageSEO> = {
  ...
  '/kids/hymns': {
    ...
    description: 'أكبر مكتبة ترانيم أطفال مسيحية قبطية بالعربية - TaranemToon والحياة الأفضل',
    keywords: ['ترانيم أطفال', 'ترانيم مسيحية', 'كارتون مسيحي', 'TaranemToon'],
  },
  '/kids/videos': {
    title: 'قصص الكتاب المقدس للأطفال | رفيقي',
    description: 'قصص العهدين القديم والجديد بالفيديو للأطفال',
    keywords: ['قصص الكتاب المقدس', 'أطفال', 'كارتون مسيحي'],
  },
  '/kids/stories': {
    title: 'قصص مصورة للأطفال | رفيقي',
    description: 'قصص مصورة تفاعلية من الكتاب المقدس للأطفال',
    keywords: ['قصص مصورة', 'كتاب مقدس', 'أطفال'],
  },
  '/emotions': {
