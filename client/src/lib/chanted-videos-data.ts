...
export const chanteVideos: Record<string, Record<number, ChanteEntry>> = {
  ...
  // ── أسفار تحتاج timestamps من الفيديو الكامل (تُضاف لاحقاً) ────────────────
  // هوشع: IKbDswn1rqc | نحميا: YLUzWG8Rjk4 | حزقيال: lSsfL28GBMQ
  // يشوع بن سيراخ: 01QkuSlB36Y | طوبيا: QEDp8uq75oQ | يونان: 6Wns4Om4c8c
  // ── رسالة العبرانيين ─────────────────────────────────────────────────────────
  "العبرانيين": {
    12: "8UNxBtUyGZA",
  },
